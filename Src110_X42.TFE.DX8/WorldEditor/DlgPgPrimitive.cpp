    ...
    case PT_CONUS:
      {
        ...
        GetDlgItem(IDC_EDIT1_T)->SetWindowText( "Shear x:");
        GetDlgItem(IDC_EDIT2)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->SetWindowText( "Shear y:");
        GetDlgItem(IDC_EDIT3)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT3_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT3_T)->SetWindowText( "Base vtx:");
        GetDlgItem(IDC_EDIT4)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->SetWindowText( "Stretch x:");
        GetDlgItem(IDC_EDIT5)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT5_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT5_T)->SetWindowText( "Stretch y:");
    ...
    case PT_TORUS:
      {
        ...
        GetDlgItem(IDC_EDIT1)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT1_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT1_T)->SetWindowText( "Slices in 360:");
        GetDlgItem(IDC_EDIT2)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->SetWindowText( "No of slices:");
        GetDlgItem(IDC_EDIT3)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT3_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT3_T)->SetWindowText( "Base vtx:");
        GetDlgItem(IDC_EDIT4)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->SetWindowText( "Radius:");
    ...
    case PT_STAIRCASES:
      {
        ...
        GetDlgItem(IDC_EDIT2)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->SetWindowText( "No of stairs:");
        GetDlgItem(IDC_EDIT3)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_EDIT3_T)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_EDIT4)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_EDIT4_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->SetWindowText( "Top:");
        GetDlgItem(IDC_EDIT5)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_EDIT5_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT5_T)->SetWindowText( "Bottom:");
        ...
        GetDlgItem(IDC_IF_SPIRAL)->SetWindowText( "Spiral:");
        ...
        else
        {
          ...
          GetDlgItem(IDC_EDIT3)->ShowWindow( SW_SHOW);
          GetDlgItem(IDC_EDIT3_T)->ShowWindow( SW_SHOW);
          GetDlgItem(IDC_EDIT3_T)->SetWindowText( "Radius:");
          GetDlgItem(IDC_IF_OUTER)->ShowWindow( SW_SHOW);
        }
        m_fEdit1 = (float)theApp.m_vfpCurrent.vfp_iSlicesIn360;
        m_fEdit2 = (float)theApp.m_vfpCurrent.vfp_iNoOfSlices;
    ...
    case PT_SPHERE:
      {
        ...
        GetDlgItem(IDC_EDIT1)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT1_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT1_T)->SetWindowText( "Meridians:");
        GetDlgItem(IDC_EDIT2)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->SetWindowText( "Parallels:");
        GetDlgItem(IDC_EDIT3)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_EDIT3_T)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_TOP_SHAPE)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_BOTTOM_SHAPE)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_IF_SPIRAL)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_IF_SPIRAL)->SetWindowText( "Equal parallels:");
        GetDlgItem(IDC_IF_OUTER)->ShowWindow( SW_HIDE);
    ...
    case PT_TERRAIN:
      {
        ...
        GetDlgItem(IDC_EDIT1)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT1_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT1_T)->SetWindowText( "Slices per W:");
        GetDlgItem(IDC_EDIT2)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT2_T)->SetWindowText( "Slices per H");
        GetDlgItem(IDC_EDIT4)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT4_T)->SetWindowText( "Mip start");
        GetDlgItem(IDC_EDIT5)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT5_T)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT5_T)->SetWindowText( "Mip step");
        GetDlgItem(IDC_TOP_SHAPE)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_BOTTOM_SHAPE)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_IF_SPIRAL)->ShowWindow( SW_HIDE);
        GetDlgItem(IDC_IF_OUTER)->ShowWindow( SW_HIDE);
        ...
        GetDlgItem(IDC_EDIT3)->ShowWindow( SW_SHOW);
        GetDlgItem(IDC_EDIT3_T)->SetWindowText( "Amplitude:");
        GetDlgItem(IDC_EDIT3_T)->ShowWindow( SW_SHOW);
