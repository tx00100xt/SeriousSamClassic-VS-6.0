...
void CDlgBrowseByClass::AddEntity( CEntity *pen)
{
  ...
  for( INDEX iColumn=COLUMN_CLASS; iColumn<COLUMN_PROPERTY_START+_ctProperties; iColumn++)
  {
    ...
    sprintf( achrTemp, "%s", CString(strValue));
    itItem.pszText = achrTemp;
...
void CDlgBrowseByClass::InitializeListColumns(void)
{
  ...
  m_listEntities.InsertColumn( COLUMN_CLASS, "Class", LVCFMT_LEFT, pixEntityClassName);
  m_listEntities.InsertColumn( COLUMN_NAME, "Name", LVCFMT_LEFT, pixInstanceName);
  m_listEntities.InsertColumn( COLUMN_DESCRIPTION, "Description", LVCFMT_LEFT, pixDescription);
  m_listEntities.InsertColumn( COLUMN_SECTOR_NAME, "Sector name", LVCFMT_LEFT, pixSectorName);
  m_listEntities.InsertColumn( COLUMN_INDEX, "No", LVCFMT_LEFT, pixEntityIndex);
  m_listEntities.InsertColumn( COLUMN_SPAWN_FLAGS, "Spawn Flags", LVCFMT_LEFT, pixSpawnFlags);
  m_listEntities.InsertColumn( COLUMN_DISTANCE, "Distance", LVCFMT_LEFT, pixDistance);
  ...
  m_listEntities.InsertColumn( COLUMN_X, "X", LVCFMT_LEFT, pixPlacement);
  m_listEntities.InsertColumn( COLUMN_Y, "Y", LVCFMT_LEFT, pixPlacement);
  m_listEntities.InsertColumn( COLUMN_Z, "Z", LVCFMT_LEFT, pixPlacement);
  m_listEntities.InsertColumn( COLUMN_H, "H", LVCFMT_LEFT, pixPlacement);
  m_listEntities.InsertColumn( COLUMN_P, "P", LVCFMT_LEFT, pixPlacement);
  m_listEntities.InsertColumn( COLUMN_B, "B", LVCFMT_LEFT, pixPlacement);
...
{
  m_ctrlPluggins.AddString("None");
  m_ctrlPluggins.AddString("Random select");
  m_ctrlPluggins.AddString("Random deselect");
  m_ctrlPluggins.AddString("Random heading");
  m_ctrlPluggins.AddString("Random pitch");
  m_ctrlPluggins.AddString("Random banking");
