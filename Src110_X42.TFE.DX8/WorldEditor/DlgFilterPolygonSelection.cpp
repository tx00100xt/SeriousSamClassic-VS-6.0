...
BOOL CDlgFilterPolygonSelection::OnInitDialog() 
{
  ...
  m_ctrlClusterSizeCombo.AddString( "3.125 cm");
  m_ctrlClusterSizeCombo.AddString( "6.25 cm");
  m_ctrlClusterSizeCombo.AddString( "12.5 cm");
  m_ctrlClusterSizeCombo.AddString( "25 cm");
  m_ctrlClusterSizeCombo.AddString( "0.5 m");
  m_ctrlClusterSizeCombo.AddString( "1 m");
  m_ctrlClusterSizeCombo.AddString( "2 m");
  m_ctrlClusterSizeCombo.AddString( "4 m");
  m_ctrlClusterSizeCombo.AddString( "8 m");
  m_ctrlClusterSizeCombo.AddString( "16 m");
  m_ctrlClusterSizeCombo.AddString( "32 m");
  m_ctrlClusterSizeCombo.AddString( "64 m");
  m_ctrlClusterSizeCombo.AddString( "128 m");
  m_ctrlClusterSizeCombo.AddString( "256 m");
  m_ctrlClusterSizeCombo.AddString( "512 m");
  m_ctrlClusterSizeCombo.AddString( "1024 m");
  m_ctrlClusterSizeCombo.SetCurSel( -1);

  m_ctrlClusterMemoryCombo.AddString( "256 kb");
  m_ctrlClusterMemoryCombo.AddString( "128 kb");
  m_ctrlClusterMemoryCombo.AddString( "32 kb");
  m_ctrlClusterMemoryCombo.AddString( "16 kb");
  m_ctrlClusterMemoryCombo.AddString( "8 kb");
  m_ctrlClusterMemoryCombo.AddString( "4 kb");
  m_ctrlClusterMemoryCombo.AddString( "2 kb");
  m_ctrlClusterMemoryCombo.AddString( "1 kb");
  m_ctrlClusterMemoryCombo.AddString( "512 bytes");
  m_ctrlClusterMemoryCombo.AddString( "256 bytes");
  m_ctrlClusterMemoryCombo.AddString( "128 bytes");
  m_ctrlClusterMemoryCombo.AddString( "64 bytes");
  m_ctrlClusterMemoryCombo.AddString( "32 bytes");
  m_ctrlClusterMemoryCombo.AddString( "16 bytes");
  m_ctrlClusterMemoryCombo.AddString( "8 bytes");
  m_ctrlClusterMemoryCombo.AddString( "4 bytes");
  m_ctrlClusterMemoryCombo.AddString( "2 bytes");
  m_ctrlClusterMemoryCombo.AddString( "1 byte");
