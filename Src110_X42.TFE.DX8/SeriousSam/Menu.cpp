...
void CNetworkStartMenu::StartMenu(void)
{
  ...
  mgNetworkGameType.mg_iSelected = Clamp(_pShell->GetINDEX("gam_iStartMode"), (INDEX)0, ctGameTypeRadioTexts-1L);
...
void CSplitStartMenu::StartMenu(void)
{
  ...
  mgSplitGameType.mg_iSelected = Clamp(_pShell->GetINDEX("gam_iStartMode"), (INDEX)0, ctGameTypeRadioTexts-1L);
