      ...
      case CEntityProperty::EPT_STRINGTRANS:
        {
          ...
          FOREACHINDYNAMICCONTAINER(pDoc->m_selEntitySelection, CEntity, iten)
          {
            ...
            iten->End();
            // set new string
            ENTITYPROPERTY( &*iten, penpProperty->ep_slOffset, CTString) = CTString(CString(m_strEditingString));
            // apply new entity settings
            iten->Initialize();
          }
                   ...
                   (ppidProperty->pid_eptType == CEntityProperty::EPT_PARENT) )
          {
            ...
            {FOREACHINDYNAMICCONTAINER(pDoc->m_woWorld.wo_cenEntities, CEntity, iten)
            {
                  ...
                  !(iten->en_ulFlags&ENF_HIDDEN))
              {
                ...
                {
                  // add it to combo
                  iAddedAs = m_EditEnumComboBox.AddString( "Unnamed");
                }
            ...
            INDEX iAddedAs = m_EditEnumComboBox.InsertString( 0, "None");
      ...
      case CEntityProperty::EPT_STRINGTRANS:
        {
          ...
          FOREACHINDYNAMICCONTAINER(pDoc->m_selEntitySelection, CEntity, iten)
          {
            ...
            else
            {
              ...
              if( CTString( CString(m_strEditingString)) != strString)
              {
