	...
	: CDialog(CDlgAutoMipModeling::IDD, pParent)
{
  ...
  m_iVerticesToRemove = theApp.GetProfileInt( "Modeler prefs", "Auto mip modeling vertex removal rate", 10);
...
void CDlgAutoMipModeling::DoDataExchange(CDataExchange* pDX)
{
  ...
  if( pDX->m_bSaveAndValidate)
  {
	...
	theApp.WriteProfileInt( "Modeler prefs", "Auto mip modeling vertex removal rate", m_iVerticesToRemove);
