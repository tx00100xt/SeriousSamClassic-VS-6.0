...
void CDlgRenderingPreferences::DoDataExchange(CDataExchange* pDX)
{
      ...
      IsWindow( m_TextureFillType.m_hWnd) )      
  {
    ...
    m_VertexFillType.AddString( "No vertices");
    m_VertexFillType.AddString( "Vertices ink");
    m_VertexFillType.AddString( "Polygon color");
    m_VertexFillType.AddString( "Sector color");
    // fill values for edges's combo box
    m_EdgesFillType.ResetContent();
    m_EdgesFillType.AddString( "No edges");
    m_EdgesFillType.AddString( "Edges ink");
    m_EdgesFillType.AddString( "Polygon color");
    m_EdgesFillType.AddString( "Sector color");
    // fill values for polygons's combo box
    m_PolygonFillType.ResetContent();
    m_PolygonFillType.AddString( "No polygons");
    m_PolygonFillType.AddString( "Polygons ink");
    m_PolygonFillType.AddString( "Polygon color");
    m_PolygonFillType.AddString( "Sector color");
    m_PolygonFillType.AddString( "Texture");
    // fill values for model's texture combo
    m_TextureFillType.ResetContent();
    m_TextureFillType.AddString( "No fill");
    m_TextureFillType.AddString( "White color");
    m_TextureFillType.AddString( "Surface colors");
    m_TextureFillType.AddString( "On colors");
    m_TextureFillType.AddString( "Off colors");
    m_TextureFillType.AddString( "Texture");
    // fill values for flare FX combo
    m_comboFlareFX.ResetContent();
    m_comboFlareFX.AddString( "None");
    m_comboFlareFX.AddString( "Single flare");
    m_comboFlareFX.AddString( "Reflections");
    m_comboFlareFX.AddString( "Reflections and glare");
