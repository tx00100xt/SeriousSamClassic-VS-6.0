...
void CDlgPgShadow::InitComboBoxes(void)
{
  ...
  // none must exist
  m_ctrlComboGradient.AddString( "None");
  ...
  m_ctrlComboClusterSize.AddString( "3.125 cm");
  m_ctrlComboClusterSize.AddString( "6.25 cm");
  m_ctrlComboClusterSize.AddString( "12.5 cm");
  m_ctrlComboClusterSize.AddString( "25 cm");
  m_ctrlComboClusterSize.AddString( "0.5 m");
  m_ctrlComboClusterSize.AddString( "1 m");
  m_ctrlComboClusterSize.AddString( "2 m");
  m_ctrlComboClusterSize.AddString( "4 m");
  m_ctrlComboClusterSize.AddString( "8 m");
  m_ctrlComboClusterSize.AddString( "16 m");
  m_ctrlComboClusterSize.AddString( "32 m");
  m_ctrlComboClusterSize.AddString( "64 m");
  m_ctrlComboClusterSize.AddString( "128 m");
  m_ctrlComboClusterSize.AddString( "256 m");
  m_ctrlComboClusterSize.AddString( "512 m");
  m_ctrlComboClusterSize.AddString( "1024 m");
}
