...
{
  mg_iSelected = Clamp(mg_iSelected, (INDEX)0, mg_ctTexts-1L);
...
void CMGServerList::AdjustFirstOnScreen(void)
{
  ...
  mg_iSelected = Clamp(mg_iSelected, (INDEX)0, ClampDn(ctSessions-1L, (INDEX)0));
  ...
  if (mg_iSelected<mg_iFirstOnScreen) {
    mg_iFirstOnScreen = ClampUp(mg_iSelected, ClampDn(ctSessions-mg_ctOnScreen-1L, (INDEX)0));
  } else if (mg_iSelected>=mg_iFirstOnScreen+mg_ctOnScreen) {
    mg_iFirstOnScreen = ClampDn(mg_iSelected-mg_ctOnScreen+1L, (INDEX)0);
  }
}
