...
InputPath=.\Release\LWSkaExporter.p
InputName=LWSkaExporter
SOURCE="$(InputPath)"

"$(ENGINE_SE110_DIR)\Bin\$(InputName).p" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy Release\$(InputName).p $(ENGINE_SE110_DIR)\Bin >nul 
...
InputPath=.\Debug\LWSkaExporterD.p
InputName=LWSkaExporterD
SOURCE="$(InputPath)"

"$(ENGINE_SE110_DIR)\Bin\Debug\$(InputName).p" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy Debug\$(InputName).p $(ENGINE_SE110_DIR)\Bin\Debug >nul 
