...
extern BOOL CheckDepthPoint( const CDrawPort *pdp, PIX pixI, PIX pixJ, FLOAT fOoK, INDEX iID, INDEX iMirrorLevel/*=0*/)
{
  ...
  // ### DX9
  for (INDEX idi = 0; idi < _adiDelayed.sa_UsedCount && idi < 20; idi++) {
