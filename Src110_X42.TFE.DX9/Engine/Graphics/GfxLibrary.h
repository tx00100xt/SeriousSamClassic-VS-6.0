...
typedef struct IDirect3D9 *LPDIRECT3D9, *PDIRECT3D9;
  // DirectX info
  LPDIRECT3D9       gl_pD3D;       // ### DX9 used to create the D3DDevice
  LPDIRECT3DDEVICE9 gl_pd3dDevice; // ### DX9 rendering device
  ...
  LPDIRECT3DVERTEXBUFFER9 gl_pd3dVtx; // ### DX9 
  LPDIRECT3DVERTEXBUFFER9 gl_pd3dNor; // ### DX9 
  LPDIRECT3DVERTEXBUFFER9 gl_pd3dCol[GFX_MAXLAYERS]; // ### DX9 
  LPDIRECT3DVERTEXBUFFER9 gl_pd3dTex[GFX_MAXLAYERS]; // ### DX9 
  LPDIRECT3DINDEXBUFFER9  gl_pd3dIdx; // ### DX9 
  // ### DX9 D3DCAPSINFO 
  D3DCAPS9		gl_pd3dCaps; 
#endif // SE1_D3D
...
#ifdef SE1_D3D  
  ULONG curVS;
  stVertexShaderInfo* _vs[1000];
  //stdext::hash_map<ULONG, stVertexShaderInfo*> mapVS;
#endif
...
// ### DX9
#ifdef SE1_D3D
  ULONG SaveVertexShader(LPDIRECT3DVERTEXSHADER9 vs, LPDIRECT3DVERTEXDECLARATION9 vDec, ULONG ulStreamFlags);
  stVertexShaderInfo* GetVertexShader(ULONG ulHandle);
  LPDIRECT3DVERTEXDECLARATION9 m_defaultDeclaration;
  LPDIRECT3DVERTEXDECLARATION9 m_defaultProgrammable;
  LPDIRECT3DVERTEXDECLARATION9 m_defaultFixed;
  void DeleteVertexShader(ULONG ulHandle);
#endif // SE1_D3D
