...
#define GET_COLOR_FROM_INI(iColor, strColorIndex) \
  ...
  strcpy( chrColor, CString(theApp.GetProfileString( "Custom picker colors", "Color" strColorIndex, CString(chrColor))));\
...
#define SET_COLOR_TO_INI(iColor, strColorIndex) \
  {char chrColor[ 16];\
  sprintf( chrColor, "0x%08x", acol_ColorizePallete[iColor]);\
  theApp.WriteProfileString( "Custom picker colors", "Color" strColorIndex, CString(chrColor));}
...
CMainFrame::~CMainFrame()
{
  ...
  pApp->WriteProfileString("World editor", "Last virtual tree", CString(m_fnLastVirtualTree));
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
  ...
  m_fnLastVirtualTree = CTString( CString(pApp->GetProfileString("World editor",
    "Last virtual tree", "VirtualTrees\\BasicVirtualTree.vrt")));
  ...
  m_wndWorkTools.SetWindowText("Work tools");
  ...
  m_wndCSGTools.SetWindowText("CSG tools");
  ...
  m_wndMipTools.SetWindowText("Mip tools");
  ...
  m_wndProjections.SetWindowText("Projections");
  ...
  m_wndSettingsAndUtility.SetWindowText("Settings and utility");
  ...
  m_wndShadowsAndTexture.SetWindowText("Shadows and texture");
  ...
  m_wndSelectEntity.SetWindowText("Select entity");
  ...
  GET_COLOR_FROM_INI( 0, "00");
  GET_COLOR_FROM_INI( 1, "01");
  GET_COLOR_FROM_INI( 2, "02");
  GET_COLOR_FROM_INI( 3, "03");
  GET_COLOR_FROM_INI( 4, "04");
  GET_COLOR_FROM_INI( 5, "05");
  GET_COLOR_FROM_INI( 6, "06");
  GET_COLOR_FROM_INI( 7, "07");
  GET_COLOR_FROM_INI( 8, "08");
  GET_COLOR_FROM_INI( 9, "09");
  GET_COLOR_FROM_INI(10, "10");
  GET_COLOR_FROM_INI(11, "11");
  GET_COLOR_FROM_INI(12, "12");
  GET_COLOR_FROM_INI(13, "13");
  GET_COLOR_FROM_INI(14, "14");
  GET_COLOR_FROM_INI(15, "15");
  GET_COLOR_FROM_INI(16, "16");
  GET_COLOR_FROM_INI(17, "17");
  GET_COLOR_FROM_INI(18, "18");
  GET_COLOR_FROM_INI(19, "19");
  GET_COLOR_FROM_INI(20, "20");
  GET_COLOR_FROM_INI(21, "21");
  GET_COLOR_FROM_INI(22, "22");
  GET_COLOR_FROM_INI(23, "23");
  GET_COLOR_FROM_INI(24, "24");
  GET_COLOR_FROM_INI(25, "25");
  GET_COLOR_FROM_INI(26, "26");
  GET_COLOR_FROM_INI(27, "27");
  GET_COLOR_FROM_INI(28, "28");
  GET_COLOR_FROM_INI(29, "29");
  GET_COLOR_FROM_INI(30, "30");
  GET_COLOR_FROM_INI(31, "31");
...
void CMainFrame::OnClose()
{
  ...
  SET_COLOR_TO_INI( 0, "00");
  SET_COLOR_TO_INI( 1, "01");
  SET_COLOR_TO_INI( 2, "02");
  SET_COLOR_TO_INI( 3, "03");
  SET_COLOR_TO_INI( 4, "04");
  SET_COLOR_TO_INI( 5, "05");
  SET_COLOR_TO_INI( 6, "06");
  SET_COLOR_TO_INI( 7, "07");
  SET_COLOR_TO_INI( 8, "08");
  SET_COLOR_TO_INI( 9, "09");
  SET_COLOR_TO_INI(10, "10");
  SET_COLOR_TO_INI(11, "11");
  SET_COLOR_TO_INI(12, "12");
  SET_COLOR_TO_INI(13, "13");
  SET_COLOR_TO_INI(14, "14");
  SET_COLOR_TO_INI(15, "15");
  SET_COLOR_TO_INI(16, "16");
  SET_COLOR_TO_INI(17, "17");
  SET_COLOR_TO_INI(18, "18");
  SET_COLOR_TO_INI(19, "19");
  SET_COLOR_TO_INI(20, "20");
  SET_COLOR_TO_INI(21, "21");
  SET_COLOR_TO_INI(22, "22");
  SET_COLOR_TO_INI(23, "23");
  SET_COLOR_TO_INI(24, "24");
  SET_COLOR_TO_INI(25, "25");
  SET_COLOR_TO_INI(26, "26");
  SET_COLOR_TO_INI(27, "27");
  SET_COLOR_TO_INI(28, "28");
  SET_COLOR_TO_INI(29, "29");
  SET_COLOR_TO_INI(30, "30");
  SET_COLOR_TO_INI(31, "31");
...
void CMainFrame::OnViewInfowindow()
{
  ...
  if( m_pInfoFrame == NULL)
  {
    ...
    if( !m_pInfoFrame->Create( NULL, "Tools info",
	  ...
	  {
		  AfxMessageBox("Failed to create info frame window m_pInfoFrame");
      return;
	  }
...
void CMainFrame::ManualToolTipOn( PIX pixManualX, PIX pixManualY)
{
  ...
  if( !m_pwndToolTip->CreateEx( WS_EX_TOPMOST, strWindowClass, "Tool tip",
