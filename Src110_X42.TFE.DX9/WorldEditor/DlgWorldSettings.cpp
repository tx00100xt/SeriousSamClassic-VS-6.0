...
void CDlgWorldSettings::DoDataExchange(CDataExchange* pDX)
{
  ...
  {
    CWorldEditorDoc *pDoc = theApp.GetDocument();
    pDoc->m_woWorld.wo_strBackdropUp = CString(m_strTopViewPicture);
    ...
    pDoc->m_woWorld.wo_strBackdropFt = CString(m_strFrontViewPicture);
    ...
    pDoc->m_woWorld.wo_strBackdropRt = CString(m_strRightViewPicture);
    ...
    pDoc->m_woWorld.wo_strBackdropObject = CString(m_strBackdropObject);
    ...
    if( m_fnBackgroundPicture != "")
    {
      theApp.WriteProfileString( "World editor prefs", "Default background picture",
    ...
    _strupr( chrColor);
    theApp.WriteProfileString( "World editor prefs", "Default background color", CString(chrColor));

    pDoc->m_woWorld.SetName( CTString(CString(m_strLevelName)));
...
void CDlgWorldSettings::OnBrowseTopViewPicture()
{
  ...
  CWorldEditorDoc *pDoc = theApp.GetDocument();
  pDoc->SetupBackdropTextureObject( CTString(CString(m_strTopViewPicture)), pDoc->m_toBackdropUp);
}
...
void CDlgWorldSettings::OnBrowseFrontViewPicture()
{
  ...
  CWorldEditorDoc *pDoc = theApp.GetDocument();
  pDoc->SetupBackdropTextureObject( CTString(CString(m_strFrontViewPicture)), pDoc->m_toBackdropFt);
}
...
void CDlgWorldSettings::OnBrowseRightViewPicture()
{
  ...
  CWorldEditorDoc *pDoc = theApp.GetDocument();
  pDoc->SetupBackdropTextureObject( CTString(CString(m_strRightViewPicture)), pDoc->m_toBackdropRt);
}
