...
# ADD CPP /nologo /G5 /MD /W3 /GX /Zi /Ox /Ot /Og /Oi /Oy- /I "$(ENGINE_SE110_DIR)\Include" /I "$(ENGINE_SE110_DIR)" /D "FIRST_ENCOUNTER" /D "SE1_D3D" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_WINDLL" /D "_AFXDLL" /D "_MBCS" /D "_USRDLL" /D "GAME_EXPORTS" /Yu"stdafx.h" /FD /c
...
# ADD LINK32 user32.lib /nologo /subsystem:windows /dll /map /debug /machine:I386 /out:"Release/Game.dll" /pdbtype:sept /libpath:"$(ENGINE_SE110_DIR)\Bin" /libpath:"$(ENGINE_SE110_DIR)\Bin\Debug" /libpath:"$(ENGINE_SE110_DIR)\Lib"
# SUBTRACT LINK32 /profile /incremental:yes
# Begin Custom Build - Copying $(InputName) binaries to $(ENGINE_SE110_DIR)\Bin
InputPath=.\Release\Game.dll
InputName=Game
SOURCE="$(InputPath)"

"$(ENGINE_SE110_DIR)\Bin\Game.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy Release\$(InputName).dll $(ENGINE_SE110_DIR)\Bin\Game.dll >nul 
	copy Release\$(InputName).map $(ENGINE_SE110_DIR)\Bin\Game.map >nul 
	copy Release\$(InputName).lib $(ENGINE_SE110_DIR)\Bin\Game.lib >nul 
...
# ADD CPP /nologo /G5 /MDd /W3 /Gm /GX /Zi /Od /I "$(ENGINE_SE110_DIR)\Include" /I "$(ENGINE_SE110_DIR)" /D "FIRST_ENCOUNTER" /D "SE1_D3D" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_WINDLL" /D "_AFXDLL" /D "_MBCS" /D "_USRDLL" /D "GAME_EXPORTS" /Yu"stdafx.h" /FD /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 user32.lib /nologo /subsystem:windows /dll /map /debug /machine:I386 /out:"Debug/GameMPD.dll" /pdbtype:sept /libpath:"$(ENGINE_SE110_DIR)\Bin" /libpath:"$(ENGINE_SE110_DIR)\Bin\Debug" /libpath:"$(ENGINE_SE110_DIR)\Lib"
