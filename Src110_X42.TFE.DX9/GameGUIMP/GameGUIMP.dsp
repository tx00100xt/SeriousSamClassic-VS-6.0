...
# ADD CPP /nologo /G5 /MD /W3 /GX /Zi /Ox /Ot /Og /Oi /Oy- /I "$(ENGINE_SE110_DIR)\Include" /I "$(ENGINE_SE110_DIR)" /D "FIRST_ENCOUNTER" /D "SE1_D3D" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "GAMEGUI_EXPORTS" /D "_WINDLL" /D "_AFXDLL" /Yu"stdafx.h" /FD /c
# SUBTRACT CPP /Ow
...
# ADD LINK32 /nologo /dll /map /debug /machine:I386 /out:"Release/GameGUI.dll" /pdbtype:sept /libpath:"$(ENGINE_SE110_DIR)\Bin" /libpath:"$(ENGINE_SE110_DIR)\Bin\Debug" /libpath:"$(ENGINE_SE110_DIR)\Lib"
# Begin Custom Build - Copying $(InputName) binaries to $(ENGINE_SE110_DIR)\Bin
InputPath=.\Release\GameGUI.dll
InputName=GameGUI
SOURCE="$(InputPath)"
...
# ADD CPP /nologo /G5 /MDd /W3 /Gm /GX /Zi /Od /I "$(ENGINE_SE110_DIR)\Include" /I "$(ENGINE_SE110_DIR)" /D "FIRST_ENCOUNTER" /D "SE1_D3D" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "GAMEGUI_EXPORTS" /D "_WINDLL" /D "_AFXDLL" /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 /nologo /dll /map /debug /machine:I386 /out:"Debug/GameGUIMPD.dll" /pdbtype:sept /libpath:"$(ENGINE_SE110_DIR)\Bin" /libpath:"$(ENGINE_SE110_DIR)\Bin\Debug" /libpath:"$(ENGINE_SE110_DIR)\Lib"
